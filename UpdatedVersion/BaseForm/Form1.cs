...
namespace BaseForm
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            // this.BackgroundImage = "Images/backgroundImage.jpg";
            //this.BackgroundImage = Properties.Resources.backgroundImage; // Replace YourImageName with your image resource
            //this.BackgroundImageLayout = ImageLayout.Stretch;
            //containerPanel.Size = new Size(Screen.PrimaryScreen.Bounds.Width, Screen.PrimaryScreen.Bounds.Height);
           // sidebarFlowPanel.BackColor = Color.FromArgb(71, 114, 250);
        ...
        private void taskButton_Click(object sender, EventArgs e)
        {
            ...
            addTaskControl.Dock = DockStyle.Fill;
            containerPanel.Controls.Add(addTaskControl);
        ...
        private void homeButton_Click(object sender, EventArgs e)
        {
            ...
            homePage.dataOnLoad();
            containerPanel.Controls.Clear();
            taskButton.BackColor = sidebarFlowPanel.BackColor;
            homePage.Dock = DockStyle.Fill;
            containerPanel.Controls.Add(homePage);
